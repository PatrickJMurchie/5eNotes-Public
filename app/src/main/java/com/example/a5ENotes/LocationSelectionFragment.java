...
public class LocationSelectionFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnItemList = view.findViewById(R.id.btnItemList);
        btnItemList.setOnClickListener(this);

        Button btnMyItems = view.findViewById(R.id.btnMyItems);
        btnMyItems.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnNotes) {
            Navigation.findNavController(v).navigate(R.id.MainToNotes);
        } else if (v.getId() == R.id.btnItemList) {
            Navigation.findNavController(v).navigate(R.id.MainToItemList);
        } else if (v.getId() == R.id.btnMyItems) {
            Navigation.findNavController(v).navigate(R.id.MainToItems);
        }
    }
}